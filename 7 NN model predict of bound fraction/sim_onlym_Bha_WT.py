...
parser.add_argument("-LW", help="specify linewidth of signals, in m/z", type=float, default=15)
parser.add_argument("-Points", help="number of points to simulate in spectrum", type=int, default=3401)
...
ds.plot(x = 'm', subplots=True, figsize=(6,1*nconc),legend=False, sharex=True, sharey=True)
